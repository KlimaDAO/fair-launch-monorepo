...
contract DeployTokens is Script {
    ...
    function run() public {
        ...
        BaseERC20 oldKlima = new BaseERC20("Klima_V0", "KLIMA_V0", 10000000 * 10 ** 9);
        console2.log("old Klima deployed at:", address(oldKlima));

        BaseERC20 newKlima = new BaseERC20("Klima", "KLIMA", 10000000 * 10 ** 18);
        console2.log("new Klima deployed at:", address(newKlima));

        BaseERC20 klimaX = new BaseERC20("KlimaX", "KLIMAX", 10000000 * 10 ** 18);
