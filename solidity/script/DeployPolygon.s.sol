...
contract DeployPolygon is Script {
    ...
    function deployContracts(address owner) internal {
        ...
        KlimaFairLaunchPolygonBurnHelper polygonHelperImplementationContract =
            new KlimaFairLaunchPolygonBurnHelper(POLYGON_INTERCHAIN_SERVICE, POLYGON_KLIMA, TOKEN_ID);
        ...
        address helperProxyAddress = address(new ERC1967Proxy(polygonHelperImplementation, helperInitData));
    ...
    function logDeploymentSummary() internal view {
        ...
        console.log(
            "   cast send --rpc-url $BASE_RPC_URL --private-key $FAIRLAUNCH_DEPLOYER_KEY <BURN_VAULT_ADDRESS> \"setHelperContractOnPolygon(address)\" ",
            address(polygonHelper)
        );
